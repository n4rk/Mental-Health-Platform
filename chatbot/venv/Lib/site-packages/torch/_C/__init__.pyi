...
class QUInt2x4StorageBase(object): ...
...
class CudaQUInt2x4StorageBase(object): ...
...
class _TensorBase(metaclass=_TensorMeta):
    ...
    def scatter_reduce(self, dim: _int, index: Tensor, reduce: str, *, output_size: Optional[_int]=None) -> Tensor: ...
    @overload
