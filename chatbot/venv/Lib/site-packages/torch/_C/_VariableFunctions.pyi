...
namedtuple_U_S_Vh = NamedTuple("namedtuple_U_S_Vh", [("U", Tensor), ("S", Tensor), ("Vh", Tensor)])
...
@overload
def _efficientzerotensor(size: _size, *, dtype: _dtype=None, layout: Optional[_layout]=strided, device: Union[_device, str, None]=None, pin_memory: _bool=False, requires_grad: _bool=False) -> Tensor: ...
@overload
def _efficientzerotensor(*size: _int, dtype: _dtype=None, layout: Optional[_layout]=strided, device: Union[_device, str, None]=None, pin_memory: _bool=False, requires_grad: _bool=False) -> Tensor: ...
...
def _foreach_norm(tensors: Union[Tuple[Tensor, ...], List[Tensor]], ord: Number=2) -> Union[Tuple[Tensor, ...], List[Tensor]]: ...
...
def _histogramdd_bin_edges(input: Tensor, bins: _size, *, range: Optional[Sequence[_float]]=None, weight: Optional[Tensor]=None, density: _bool=False) -> Union[Tuple[Tensor, ...], List[Tensor]]: ...
...
def _linalg_svd(A: Tensor, full_matrices: _bool=False, compute_uv: _bool=True, *, out: Union[Tensor, Tuple[Tensor, ...], List[Tensor]]=None) -> namedtuple_U_S_Vh: ...
...
def _masked_softmax(input: Tensor, mask: Tensor) -> Tensor: ...
...
def _native_multi_head_self_attention(query: Tensor, qkv_weight: Tensor, qkv_bias: Tensor, proj_weight: Tensor, proj_bias: Tensor, mask: Optional[Tensor]=None) -> Tensor: ...
...
def _torch_cuda_cu_linker_symbol_op(input: Tensor) -> Tensor: ...
...
def scatter_reduce(input: Tensor, dim: _int, index: Tensor, reduce: str, *, output_size: Optional[_int]=None) -> Tensor: ...
@overload
...
def select_scatter(input: Tensor, src: Tensor, dim: _int, index: _int) -> Tensor: ...
...
def slice_scatter(input: Tensor, src: Tensor, dim: _int=0, start: Optional[_int]=None, end: Optional[_int]=None, step: _int=1) -> Tensor: ...
...
__all__ = ['__and__', '__lshift__', '__or__', '__rshift__', '__xor__', '_adaptive_avg_pool2d',
 ...
 '_batch_norm_impl_index', '_cast_Byte', '_cast_Char', '_cast_Double', '_cast_Float', '_cast_Half',
 '_cast_Int', '_cast_Long', '_cast_Short', '_cat', '_choose_qparams_per_tensor', '_coalesce',
 '_compute_linear_combination', '_conj', '_conj_physical', '_convert_indices_from_coo_to_csr',
 '_convert_indices_from_csr_to_coo', '_convolution', '_convolution_mode', '_copy_from',
 '_copy_from_and_resize', '_ctc_loss', '_cudnn_ctc_loss', '_cudnn_init_dropout_state', '_cudnn_rnn',
 ...
 '_debug_has_internal_overlap', '_det_lu_based_helper', '_det_lu_based_helper_backward_helper',
 '_dim_arange', '_dirichlet_grad', '_efficientzerotensor', '_embedding_bag',
 ...
 '_foreach_norm', '_foreach_reciprocal', '_foreach_reciprocal_', '_foreach_round',
 ...
 '_fused_moving_avg_obs_fq_helper', '_grid_sampler_2d_cpu_fallback',
 '_has_compatible_shallow_copy_type', '_histogramdd_bin_edges', '_histogramdd_from_bin_cts',
 '_histogramdd_from_bin_tensors', '_index_copy_', '_index_put_impl_', '_is_zerotensor',
 '_linalg_check_errors', '_linalg_inv_out_helper_', '_linalg_qr_helper', '_linalg_svd',
 '_log_softmax', '_log_softmax_backward_data', '_logcumsumexp', '_lu_with_info', '_make_dual',
 ...
 '_native_multi_head_self_attention', '_neg_view', '_nnpack_available',
 ...
 '_sparse_broadcast_to', '_sparse_coo_tensor_unsafe', '_sparse_csr_tensor_unsafe',
 '_sparse_log_softmax_backward_data', '_sparse_mask_helper', '_sparse_mm',
 '_sparse_softmax_backward_data', '_sparse_sparse_matmul', '_sparse_sum', '_stack',
 '_standard_gamma', '_standard_gamma_grad', '_test_serialization_subcmul', '_to_cpu',
 '_torch_cuda_cu_linker_symbol_op', '_trilinear', '_unique', '_unique2', '_unpack_dual',
 '_use_cudnn_ctc_loss', '_use_cudnn_rnn_flatten_weight', '_validate_sparse_coo_tensor_args',
 '_validate_sparse_csr_tensor_args', '_weight_norm', '_weight_norm_cuda_interface', 'abs', 'abs_',
 'absolute', 'acos', 'acos_', 'acosh', 'acosh_', 'adaptive_avg_pool1d', 'adaptive_max_pool1d',
 'add', 'addbmm', 'addcdiv', 'addcmul', 'addmm', 'addmv', 'addmv_', 'addr', 'adjoint',
 ...
 'argmin', 'argsort', 'argwhere', 'as_strided', 'as_strided_', 'as_tensor', 'asarray', 'asin',
 ...
 'diag_embed', 'diagflat', 'diagonal', 'diagonal_scatter', 'diff', 'digamma', 'dist', 'div',
 'divide', 'dot', 'dropout', 'dropout_', 'dsmm', 'dsplit', 'dstack', 'eig', 'embedding',
 'embedding_bag', 'embedding_renorm_', 'empty', 'empty_like', 'empty_quantized', 'empty_strided',
 'eq', 'equal', 'erf', 'erf_', 'erfc', 'erfc_', 'erfinv', 'exp', 'exp2', 'exp2_', 'exp_', 'expm1',
 'expm1_', 'eye', 'fake_quantize_per_channel_affine', 'fake_quantize_per_tensor_affine',
 ...
 'fbgemm_linear_quantize_weight', 'fbgemm_pack_gemm_matrix_fp16', 'fbgemm_pack_quantized_matrix',
 'feature_alpha_dropout', 'feature_alpha_dropout_', 'feature_dropout', 'feature_dropout_', 'fill_',
 'fix', 'fix_', 'flatten', 'flip', 'fliplr', 'flipud', 'float_power', 'floor', 'floor_',
 'floor_divide', 'fmax', 'fmin', 'fmod', 'frac', 'frac_', 'frexp', 'frobenius_norm', 'from_file',
 'from_numpy', 'frombuffer', 'full', 'full_like', 'fused_moving_avg_obs_fake_quant', 'gather',
 'gcd', 'gcd_', 'ge', 'geqrf', 'ger', 'get_default_dtype', 'get_num_interop_threads',
 'get_num_threads', 'gradient', 'greater', 'greater_equal', 'grid_sampler', 'grid_sampler_2d',
 'grid_sampler_3d', 'group_norm', 'gru', 'gru_cell', 'gt', 'hamming_window', 'hann_window',
 'hardshrink', 'heaviside', 'hinge_embedding_loss', 'histc', 'histogram', 'hsmm', 'hsplit', 'hspmm',
 ...
 'instance_norm', 'int_repr', 'inverse', 'is_complex', 'is_conj', 'is_distributed',
 'is_floating_point', 'is_grad_enabled', 'is_inference', 'is_inference_mode_enabled', 'is_neg',
 'is_nonzero', 'is_same_size', 'is_signed', 'is_vulkan_available', 'isclose', 'isfinite', 'isin',
 'isinf', 'isnan', 'isneginf', 'isposinf', 'isreal', 'istft', 'kaiser_window', 'kl_div', 'kron',
 ...
 'lstsq', 'lt', 'lu_solve', 'lu_unpack', 'margin_ranking_loss', 'masked_fill', 'masked_scatter',
 'masked_select', 'matmul', 'matrix_exp', 'matrix_power', 'matrix_rank', 'max', 'max_pool1d',
 'max_pool1d_with_indices', 'max_pool2d', 'max_pool3d', 'maximum', 'mean', 'median', 'min',
 'minimum', 'miopen_batch_norm', 'miopen_convolution', 'miopen_convolution_transpose',
 ...
 'namedtuple_U_S_Vh', 'namedtuple_a_tau', 'namedtuple_det_lu_pivs',
 'namedtuple_eigenvalues_eigenvectors', 'namedtuple_hist_bin_edges', 'namedtuple_mantissa_exponent',
 'namedtuple_min_max', 'namedtuple_output_mask', 'namedtuple_primal_tangent',
 'namedtuple_sign_logabsdet', 'namedtuple_solution_LU', 'namedtuple_solution_QR',
 'namedtuple_solution_cloned_coefficient', 'namedtuple_values_indices', 'nan_to_num', 'nan_to_num_',
 'nanmean', 'nanmedian', 'nanquantile', 'nansum', 'narrow', 'narrow_copy', 'native_batch_norm',
 ...
 'quantize_per_tensor', 'quantize_per_tensor_dynamic', 'quantized_batch_norm', 'quantized_gru_cell',
 'quantized_lstm_cell', 'quantized_max_pool1d', 'quantized_max_pool2d', 'quantized_rnn_relu_cell',
 ...
 'rsqrt_', 'rsub', 'saddmm', 'scalar_tensor', 'scatter', 'scatter_add', 'scatter_reduce',
 'searchsorted', 'segment_reduce', 'select', 'select_scatter', 'selu', 'selu_',
 'set_flush_denormal', 'set_num_interop_threads', 'set_num_threads', 'sgn', 'sigmoid', 'sigmoid_',
 'sign', 'signbit', 'sin', 'sin_', 'sinc', 'sinc_', 'sinh', 'sinh_', 'slice_scatter', 'slogdet',
 'smm', 'softmax', 'solve', 'sort', 'sparse_coo_tensor', 'sparse_csr_tensor', 'split_with_sizes',
 'spmm', 'sqrt', 'sqrt_', 'square', 'square_', 'squeeze', 'sspaddmm', 'stack', 'std', 'std_mean',
 'sub', 'subtract', 'sum', 'svd', 'swapaxes', 'swapdims', 'symeig', 't', 'take', 'take_along_dim',
 'tan', 'tan_', 'tanh', 'tanh_', 'tensor', 'tensor_split', 'threshold', 'threshold_', 'tile',
 'topk', 'trace', 'transpose', 'trapezoid', 'trapz', 'triangular_solve', 'tril', 'tril_indices',
 ...
 'var', 'var_mean', 'vdot', 'view_as_complex', 'view_as_real', 'vsplit', 'vstack', 'where', 'xlogy',
